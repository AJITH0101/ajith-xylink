...
<div style={{ fontFamily: "Poppins, sans-serif" }} className='w-full'>
      <div className='lg:w-[75rem] h-[35rem] border border-stone-800 rounded-lg flex justify-center items-center  transition-transform duration-1000 mt-13' style={{
        transform: `perspective(600px) rotateX(${lift ? "0deg" : "90deg"})`,
        transformOrigin: "bottom",
      }}>

            <div className='lg:w-[70rem] h-[30rem] border border-stone-800 bg-black rounded-lg flex justify-end bg-stone-950 '
          style={{
